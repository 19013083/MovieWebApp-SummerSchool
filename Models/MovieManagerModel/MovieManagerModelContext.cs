...
{
    public partial class MovieManagerModelContext : DbContext
    {
        public MovieManagerModelContext()
        {
        }

        public MovieManagerModelContext(DbContextOptions<MovieManagerModelContext> options)
            : base(options)
        {
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<FavouriteUserMovie>(entity =>
            {
                ...
                entity.HasOne(d => d.User)
                    ...
                    .HasConstraintName("FK__favourite__User___5FB337D6");
            });
